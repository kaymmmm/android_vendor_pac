...
ifeq (pac_geefhd_att_us,$(TARGET_PRODUCT))

# OVERLAY_TARGET adds overlay asset source
OVERLAY_TARGET := pa_xxhdpi

# AOKP device overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/pac/overlay/aokp/device/geefhd
...
$(call inherit-product, device/lge/geefhd_att_us/cm.mk)

PRODUCT_NAME := pac_geefhd_att_us
